...
data = datagovin.get_data("9ef84268-d588-465a-a308-a864a43d0070",
                          num_results='all',
                          filters={'state': 'Tamilnadu', 'city': "Karur"})
o = data['commodity']
v = data['modal_price']
o = list(o)
u = []
...
def market(crop):
    ...
    sentencei = crop
    print(sentencei)
    p = (get_close_matches(sentencei, u))
    print(p)
    if len(p) == 0:
        e = "Make a call to Kisan Call Centre "
    else:
        e = m[sentencei]
    print(e)
    return e"""
